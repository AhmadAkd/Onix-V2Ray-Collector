...
echo "  1. Check GitHub Actions: https://github.com/AhmadAkd/V2Ray_Collector/actions"
echo "  2. Verify changes: https://github.com/AhmadAkd/V2Ray_Collector"
echo "  3. Create Release: https://github.com/AhmadAkd/V2Ray_Collector/releases/new"
